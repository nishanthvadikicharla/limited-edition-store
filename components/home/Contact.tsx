...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const recipient = "business@refarmsoil.com";
    ...
    const body = encodeURIComponent(
      ...
      `Role/Designation: ${form.designation || "N/A"}\n` +
            ...
            <div className="space-y-6 relative z-10">
              <div>
                ...
                <p className="text-xs sm:text-sm text-stone-500 mt-1">
                  Fill out the form below to transmit your details straight to business@refarmsoil.com.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-full bg-stone-900 hover:bg-emerald-900 text-stone-50 font-bold text-xs uppercase tracking-widest shadow-md transition-all flex items-center justify-center gap-2 mt-2"
                >
